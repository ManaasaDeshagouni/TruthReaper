...
CLIP_FOLDER = "clips/deception"

def get_next_filename():
    existing = [f for f in os.listdir(CLIP_FOLDER) if f.startswith("trial_lie_custom") and f.endswith(".wav")]
    next_num = len(existing) + 1
    return f"trial_lie_{next_num:03d}.wav"
